...
Чтобы открыть консоль, прикоснитесь к экрану 4 пальцами одновременно. В консоли можно увидить ошибки синтаксиса Lua, и некоторые другие ошибки.
...
При первой загрузке мисии с новым ключом всегда устанавливаються такие данные: ID выполненных миссий [0], ID иследованной техники [0], ID выбранной техники: 0. Таким образом техника с 0 ID (стартовая) будет сразу же преобретина и выбранна.
